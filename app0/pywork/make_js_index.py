# coding=utf-8
""" make_js_index.py for bhartrhari repo
"""
...
if __name__ == "__main__":
 ...
 pagerecs_latina = init_pagerecs_latina()
 outrecs_latina = make_js(pagerecs_latina)
 # commentarius
 pagerecs_commentarius = init_pagerecs_commentarius()
 outrecs_commentarius = make_js(pagerecs_commentarius)
 # addenda
 pagerecs_addenda = init_pagerecs_addenda()
 outrecs_addenda = make_js(pagerecs_addenda)
 outrecs = (outrecs_preface + outrecs_main + outrecs_latina +
            outrecs_commentarius + outrecs_addenda)
